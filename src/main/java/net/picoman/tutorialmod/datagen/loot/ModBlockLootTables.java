...
public class ModBlockLootTables extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        this.add(ModBlocks.SAPPHIRE_SLAB.get(),
                block -> createSlabItemTable(ModBlocks.SAPPHIRE_SLAB.get())); //les slab et portes droppent de manière différente parce que la porte c'est deux textures collées et les slab peuvent former un bloc si on les superpose
