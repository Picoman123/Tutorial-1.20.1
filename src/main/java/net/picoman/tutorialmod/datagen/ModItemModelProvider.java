...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        trimmedArmorItem(ModItems.SAPPHIRE_HELMET); //utilise la fonction plus bas pour faire en sorte que ce soit trimmable
    ...
    private ItemModelBuilder simpleBlockItemBlockTexture(RegistryObject<Block> item) { //il faut créer une nouvelle fonction pour les fleurs parce que la texture est dans les blocs et non dans les items
        return withExistingParent(item.getId().getPath(),
                new ResourceLocation("item/generated")).texture("layer0",
