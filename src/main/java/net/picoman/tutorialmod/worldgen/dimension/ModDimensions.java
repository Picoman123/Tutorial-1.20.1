package net.picoman.tutorialmod.worldgen.dimension;
...
//utiliser Misode pour voir ce que le biome va donner
...
public class ModDimensions {
    ...
    public static void bootstrapStem(BootstapContext<LevelStem> context) {
        ...
        NoiseBasedChunkGenerator wrappedChunkGenerator = new NoiseBasedChunkGenerator(
                new FixedBiomeSource(biomeRegistry.getOrThrow(ModBiomes.TEST_BIOME)), //fixedBiomeSource veut dire qu'il n'y a qu'un biome dans la dimension
                noiseGenSettings.getOrThrow(NoiseGeneratorSettings.AMPLIFIED));

        NoiseBasedChunkGenerator noiseBasedChunkGenerator = new NoiseBasedChunkGenerator(
                MultiNoiseBiomeSource.createFromList( //MutliNoiseBiomeSource veut dire plusieurs biomes dans la dimension
