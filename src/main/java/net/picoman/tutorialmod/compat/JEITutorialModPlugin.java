...
public class JEITutorialModPlugin implements IModPlugin {
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        List<GemPolishingRecipe> polishingRecipes = recipeManager.getAllRecipesFor(GemPolishingRecipe.Type.INSTANCE); //prend toutes les recettes de gemmes polies
        registration.addRecipes(GemPolishingCategory.GEM_POLISHING_TYPE, polishingRecipes); //on assigne le type GemPolyshingType au recette de gemmes polies
    }
